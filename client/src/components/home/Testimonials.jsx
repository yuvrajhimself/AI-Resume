...
const cardsData = [
 ...
 <>
        ...
        `}</style>
    <div id='testimonials' className="flex flex-col items-center justify-center gap-12 py-16 px-4 md:px-8 lg:px-16 xl:px-32">
         ...
         <div className="flex items-center gap-2 text-sm text-green-800 bg-green-400/10  rounded-full px-6 py-1.5">
            ...
            {/* //BookUserIcon- this is a book user icon in react lucide icons */}
            <span>Testimonials            </span>
         </div>
            <Title title="Dont just take our words" description="Hear what out users say about us. We're always looking for ways to improve . If u have a positive
